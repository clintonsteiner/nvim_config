...
wk.register({
    ...
    g = {name = "git",
        b = {name = "blame",
            b = {"<cmd>lua fzf_git_blame()<CR>", "file"},
    ...
    p = {name = "pytest",
        ...
        z = {"<cmd>lua require('FTerm').scratch({cmd = {'pytest', '-sv', '--disable-pytest-warnings', '--pdb', '-k', get_current_function_name()}, hl = 'Normal,FloatBorder:FzfLuaBorder'})<CR>", "under cursor"},
    },
    r = {name = "ripgrep",
