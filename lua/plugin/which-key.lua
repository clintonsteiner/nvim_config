...
wk.register({
    ...
    p = {name = "pytest",
        ...
        z = {"<cmd>lua require('FTerm').scratch({cmd = {'pytest', '-sv', '--disable-pytest-warnings', '--pdb', vim.fn.expand('%:p'), '-k', get_current_function_name()}, hl = 'Normal,FloatBorder:FzfLuaBorder'})<CR>", "under cursor"},
    },
    r = {name = "ripgrep",
